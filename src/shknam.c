...
static const char *const shkjunk[] = {
    ...
    "=Spiffy",  "=Bonko",   "=Binky",       "=Tubby",   "=Zippy",
    "=Jumbo",   "=Mittens", "=Chuckles",    "=Bam Bam", "=Larry",
    "=Curly",   "=Moe",     "=Zaff",        "=Punky",   "=Zonko",
    0
};
...
const struct shclass shtypes[] = {
    ...
    { "delicatessen", "food shop",
      ...
      { { 78, FOOD_CLASS },
        ...
        { 5, -POT_WATER },
        { 3, -ICE_BOX },
        { 0, -TIN_OPENER }, /* Allow buying/selling these */
        { 0, 0 } },
      shkfoods },
    { "jewelers", "ring shop",
      RING_CLASS,
...
shkinit(const struct shclass *shp, struct mkroom *sroom)
{
    ...
    eshkp->customer[0] = '\0';
    mkmonmoney(shk, 1500L + 65L * (long) rnd(100)); /* initial capital */
