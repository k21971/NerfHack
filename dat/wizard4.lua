...
-- hackemslashem reduced the complexity of the maze from 27 rooms to 15
-- and also added annoying monsters
...
-- The hole in room 10 is in case a player gets into this level without
...
des.monster({ id = prisoners[1], x = 16, y = 14, peaceful = 0 })
des.monster({ id = prisoners[2], x = 11, y = 12, peaceful = 0 })
des.monster({ id = prisoners[3], x = 09, y = 03, peaceful = 0 })
des.monster({ id = prisoners[4], x = 19, y = 03, peaceful = 0 })
