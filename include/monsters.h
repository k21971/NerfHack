 ...
 */
     ...
     * ants
     */
    /* Baalzebub also can spawn hordes of giant flies */
    MON(NAM("giant fly"), S_ANT,
        LVL(0, 18, 5, 0, 0), (G_GENO | G_SGROUP | 3),
    ...
    MON(NAM("revenant pup"), S_DOG,
        ...
        MH_UNDEAD, 5, CLR_BRIGHT_BLUE, REVENANT_PUP),
    MON(NAM("dog"), S_DOG,
    ...
    MON(NAM("revenant hound"), S_DOG,
        LVL(12, 15, 2, 30, 0), (G_GENO | G_SGROUP | 1),
        A(ATTK(AT_BITE, AD_PHYS, 2, 8),
          ATTK(AT_CLAW, AD_COLD, 1, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(800, 250, MS_BARK, MZ_MEDIUM), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_WALLWALK | M1_ANIMAL | M1_NOHANDS | M1_REGEN,
    ...
    MON(NAM("freezing sphere"), S_EYE,
        LVL(6, 13, 4, 0, 0), (G_GENO | G_NOCORPSE | G_NOHELL | 2),
    ...
    MON(NAM("stinking sphere"), S_EYE,
        LVL(6, 13, 4, 0, 0), (G_GENO | G_NOCORPSE | 2),
        A(ATTK(AT_EXPL, AD_PHYS, 4, 6),
          ATTK(AT_BOOM, AD_PHYS, 4, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(10, 10, MS_SILENT, MZ_SMALL), 0, 0,
        M1_FLY | M1_BREATHLESS | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS
    ...
    MON(NAM("acid sphere"), S_EYE,
        LVL(7, 13, 4, 0, 0), (G_GENO | G_NOCORPSE | 2),
    ...
    MON(NAM("compsognathus"), S_ZRUTY,
        LVL(3, 15, 5, 0, 0), (G_GENO | G_VLGROUP | 6),
        A(ATTK(AT_BITE, AD_PHYS, 1, 4),
          ATTK(AT_CLAW, AD_PHYS, 1, 2),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON(NAM("dark Angel"), S_ANGEL,
        ...
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), 
          ATTK(AT_WEAP, AD_PHYS, 1, 6),
          ATTK(AT_GAZE, AD_STUN, 1, 4),
          ATTK(AT_TUCH, AD_DRLI, 1, 6),
          NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_CUSS, MZ_HUMAN),
        MR_COLD | MR_ELEC | MR_SLEEP | MR_POISON, 0,
        M1_FLY | M1_HUMANOID | M1_SEE_INVIS,
    ...
    MON(NAM("phoenix"), S_BAT,
        ...
        A(ATTK(AT_BITE, AD_PHYS, 2, 6),
          ...
          NO_ATTK, NO_ATTK),
        SIZ(40, 20, MS_SQAWK, MZ_SMALL), MR_FIRE | MR_COLD, MR_FIRE,
    ...
    MON(NAM("gnoll"), S_GNOLL,
        ...
        A(ATTK(AT_BITE, AD_DISE, 1, 6),
          ...
          ATTK(AT_WEAP, AD_PHYS, 3, 6),
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1200, 300, MS_GNOLL, MZ_MEDIUM), MR_POISON | MR_FIRE | MR_SLEEP, 0,
    ...
    MON(NAM("gnoll warrior"), S_GNOLL,
        ...
        A(ATTK(AT_BITE, AD_DISE, 1, 6),
          ...
          ATTK(AT_WEAP, AD_PHYS, 3, 6),
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1800, 100, MS_GNOLL, MZ_LARGE), MR_POISON | MR_FIRE | MR_SLEEP, 0,
        M1_HUMANOID | M1_POIS | M1_SEE_INVIS | M1_OMNIVORE,
        M2_NOPOLY | M2_HOSTILE | M2_COLLECT | M2_MAGIC | M2_GREEDY
    ...
    */
    ...
    MON(NAM("Keystone Kop"), S_KOP,
        LVL(3, 10, 10, 10, 9), (G_GENO | G_LGROUP | G_NOGEN),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON(NAM("kobold mummy"), S_MUMMY,
        LVL(3, 8, 5, 20, -2), (G_GENO | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 4),
    ...
    MON(NAM("troll mummy"), S_MUMMY,
        LVL(9, 14, 2, 30, -8), (G_GENO | G_NOCORPSE | 1),
    ...
    MON(NAM("like-like"), S_PUDDING,
        LVL(6, 8, 8, 0, 0), (G_GENO | G_NOCORPSE | 1),
    ...
    MON(NAM("hunger hulk"), S_UMBER,
        ...
        A(ATTK(AT_TUCH, AD_HNGY, 3, 4),
          ATTK(AT_TUCH, AD_HNGY, 3, 4),
    ...
    MON(NAM("Executioner"), S_HUMAN,
        ...
        A(ATTK(AT_WEAP, AD_PHYS, 5, 10),
          ATTK(AT_WEAP, AD_PHYS, 5, 10),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_GUARD, MZ_HUMAN),
...
#define SEDUCTION_ATTACKS_NO                                      \
    ...
    */
    ...
    MON(NAM("King Arthur"), S_HUMAN,
        ...
        MR_POISON | MR_FIRE | MR_COLD | MR_ELEC | MR_SLEEP, 0,
        M1_HUMANOID | M1_OMNIVORE | M1_SEE_INVIS,
        M2_NOPOLY | M2_PNAME | M2_PEACEFUL | M2_STRONG | M2_MALE
            | M2_COLLECT | M2_MAGIC,
        M3_CLOSE | M3_INFRAVISIBLE,
    ...
    MON(NAM("Chromatic Dragon"), S_DRAGON,
        LVL(16, 20, -4, 30, -14), (G_NOGEN | G_UNIQ),
