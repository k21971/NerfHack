...
extern int back_to_defsym(coordxy, coordxy);
...
extern void Amulet_on(struct obj *);
...
extern boolean thrwmu(struct monst *) NONNULLARG1;
...
extern void seffect_flood(struct obj **, struct monst *);
...
extern boolean hates_item(struct monst *, int);
