...
struct dgn_topology { /* special dungeon levels for speed */
    ...
    d_level d_tomb_level;
    d_level d_temple_level;
...
#define tomb_level              (svd.dungeon_topology.d_tomb_level)
#define temple_level            (svd.dungeon_topology.d_temple_level)
...
#define DEVTEAM_URL "https://github.com/elunna/NerfHack/"
