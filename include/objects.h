...
WEAPON("shuriken", "throwing star",
       0, 1, 0, 35,   2,   5,  8,  6, 2, P,   -P_SHURIKEN, IRON, HI_METAL,
                                                        SHURIKEN),
/* The cartomancer's shuriken. */
WEAPON("razor card", NoDes,
       1, 1, 0,  0,   1,   5,  6,  6, 2, P,   -P_SHURIKEN, IRON, HI_METAL,
                                                        RAZOR_CARD),
...
WEAPON("elven spear", "runed spear",
       0, 1, 0, 10,  20,   3,  7,  8, 0, P,   P_SPEAR, WOOD, HI_WOOD,
                                                        ELVEN_SPEAR),
...
WEAPON("elven dagger", "runed dagger",
       0, 1, 0, 10,   6,   4,  5,  3, 2, P,   P_DAGGER, WOOD, HI_WOOD,
                                                        ELVEN_DAGGER),
...
WEAPON("short sword", NoDes,
       1, 0, 0,  8,  30,  10,  6,  8, 1, P,   P_SHORT_SWORD, IRON, HI_METAL,
                                                        SHORT_SWORD),
WEAPON("silver short sword", NoDes,
       1, 0, 0,  2,  36,  50,  6,  8, 0, P,   P_SHORT_SWORD, SILVER, HI_SILVER,
                                                        SILVER_SHORT_SWORD),
WEAPON("elven short sword", "runed short sword",
       0, 0, 0,  2,  20,  10,  8,  8, 1, P,   P_SHORT_SWORD, WOOD, HI_WOOD,
                                                        ELVEN_SHORT_SWORD),
...
WEAPON("elven broadsword", "runed broadsword",
       0, 0, 0,  4,  45,  10,  6,  6, 0, S,   P_BROAD_SWORD, WOOD, HI_WOOD,
                                                        ELVEN_BROADSWORD),
        /* +d4 small, +1 large */
...
WEAPON("heavy sword", NoDes,
       1, 0, 1,  0, 500,  50, 6,  8, -10, S,   P_TWO_HANDED_SWORD, MINERAL,
...
WEAPON("scythe", "curved polearm",
       0, 0, 1,  0, 120,   10,  8, 10, -2, S, P_POLEARMS, IRON, HI_METAL,
                                                        SCYTHE),
       /* +1d4 both */
...
HELM("gnomish helm", "little red hat",
     0, 0,           0,  1, 1,  3,  8,  9, 0, CLOTH, CLR_RED, GNOMISH_HELM),
...
HELM("fire helmet", "red shiny helmet",
     0, 0,    FIRE_RES,  5, 1, 50, 50,  9, 0, IRON, CLR_RED,
                                                        FIRE_HELMET),
HELM("oilskin helm", "slippery helm",
     0, 0,           0,  3, 1, 20, 50,  9,  0, CLOTH, CLR_GRAY,
                                                        OILSKIN_HELM),
 ...
 */
#define DRGN_SCALES(name,mgc,power,cost,color,snam) \
    ARMOR(name, NoDes, 1, mgc, 1, power, 0, 5, 80,  \
          cost, 7, 0, ARM_CLOAK, DRAGON_HIDE, color,snam)
/* For now, only dragons leave these. */
/* 3.4.1: dragon scales left classified as "non-magic"; they confer magical
   properties but are produced "naturally" */
...
ARMOR("bronze plate mail", NoDes,
      1, 0, 1,  0, 25, 5, 375, 400,  3, 2,  ARM_SUIT, COPPER, HI_COPPER,
                                                        BRONZE_PLATE_MAIL),
...
ARMOR("dwarvish mithril-coat", NoDes,
      1, 0, 0,  0, 10, 1, 200, 240,  4, 1,  ARM_SUIT, MITHRIL, HI_SILVER,
                                                        DWARVISH_MITHRIL_COAT),
ARMOR("elven mithril-coat", NoDes,
      1, 0, 0,  0, 15, 1, 150, 240,  5, 1,  ARM_SUIT, MITHRIL, HI_SILVER,
                                                        ELVEN_MITHRIL_COAT),
...
SHIELD("anti-magic shield", "hide shield",
       0, 1, 0,  ANTIMAGIC, 2, 0,  25, 75, 9, 2,  LEATHER, CLR_ORANGE,
                                                        ANTI_MAGIC_SHIELD),
...
SHIELD("bracers of integrity", "chitinous bracers",
       0, 1, 0,DISINT_RES, 2, 0, 15,  50, 10, 0,  LEATHER, CLR_YELLOW,
                                               BRACERS_OF_INTEGRITY),
SHIELD("bracers of sleep resistance", "silver bracers",
       0, 1, 0, SLEEP_RES, 2, 0, 15,  50, 10, 0,  SILVER, HI_SILVER,
                                                BRACERS_OF_SLEEP_RESISTANCE),
SHIELD("bracers of cold resistance", "wire bracers",
       0, 1, 0,  COLD_RES, 2, 0, 15,  50, 10, 0,  IRON, CLR_CYAN,
                                                 BRACERS_OF_COLD_RESISTANCE),
SHIELD("bracers vs shapechangers", "braided bracers",
       0, 1, 0,PROT_FROM_SHAPE_CHANGERS, 2, 0, 15, 50, 10, 1, LEATHER,
                                        CLR_BROWN, BRACERS_VS_SHAPESHIFTERS),
SHIELD("bracers of unchanging", "bezeled bracers",
       0, 1, 0,UNCHANGING, 2, 0, 15, 50, 10, 0,  LEATHER, CLR_BLUE,
                                                      BRACERS_OF_UNCHANGING),
SHIELD("bracers vs stone", "spiral bracers",
       0, 1, 0, STONE_RES, 2, 0, 15, 50, 10, 0,  IRON, HI_COPPER,
                                                           BRACERS_VS_STONE),
/* gloves */
...
GLOVES("bronze gauntlets", "falconry gloves",
       0, 0,        0, 12, 1, 20, 30, 8, 0,  COPPER, HI_COPPER,
                                                    BRONZE_GAUNTLETS),
...
GLOVES("gauntlets of force", "boxing gloves",
...
BOOTS("dwarvish boots", "hard shoes",
      0, 0,          0,  7, 2, 50, 16, 8, 0, IRON, HI_METAL, DWARVISH_BOOTS),
BOOTS("gnomish boots", "little black boots",
      0, 0,          0,  1, 2, 10, 16, 9, 0, LEATHER, CLR_BLACK,
                                                               GNOMISH_BOOTS),
...
BOOTS("freedom boots", "winged boots",
      0, 1,FREE_ACTION, 12, 2, 20, 50, 9, 0, LEATHER, HI_LEATHER,
                                                               FREEDOM_BOOTS),
...
BOOTS("stomping boots", "steel-toed boots",
      0, 1,   STOMPING, 12, 2, 50, 50, 9, 0, IRON, HI_LEATHER,
                                                        STOMPING_BOOTS),
BOOTS("elven boots", "mud boots",
      0, 1,    STEALTH, 12, 2, 10,  8, 9, 0, LEATHER, HI_LEATHER,
                                                        ELVEN_BOOTS),
...
/* rings ... */
#define RING(name,stone,power,prob,cost,mgc,spec,mohs,metal,color,sn) \
    OBJECT(OBJ(name, stone),                                          \
           BITS(0, 0, spec, 0, mgc, spec, 0, 0, 0,                    \
                HARDGEM(mohs), 0, P_NONE, metal),                     \
           power, RING_CLASS, prob, 0, 3, cost, 0, 0, 0, 0, 15, color,sn)
RING("adornment", "wooden",
     ADORNED,                  1, 200, 1, 1, 2, WOOD, HI_WOOD, RIN_ADORNMENT),
RING("gain strength", "granite",
     0,                        1, 200, 1, 1, 7, MINERAL, HI_MINERAL,
                                                            RIN_GAIN_STRENGTH),
RING("gain constitution", "opal",
     0,                        1, 200, 1, 1, 7, MINERAL, HI_MINERAL,
                                                        RIN_GAIN_CONSTITUTION),
RING("increase accuracy", "clay",
     0,                        1, 200, 1, 1, 4, MINERAL, CLR_RED,
                                                        RIN_INCREASE_ACCURACY),
RING("increase damage", "coral",
     0,                        1, 200, 1, 1, 4, MINERAL, CLR_ORANGE,
                                                        RIN_INCREASE_DAMAGE),
RING("protection", "black onyx",
     PROTECTION,               1, 200, 1, 1, 7, MINERAL, CLR_BLACK,
                                                        RIN_PROTECTION),
...
RING("searching", "tiger eye",
     SEARCHING,                1, 200, 1, 0,  6, GEMSTONE, CLR_BROWN,
                                                        RIN_SEARCHING  ),
RING("stealth", "jade",
     STEALTH,                  1, 200, 1, 0,  6, GEMSTONE, CLR_GREEN,
                                                        RIN_STEALTH),
RING("sustain ability", "bronze",
     FIXED_ABIL,               1, 200, 1, 0,  4, COPPER, HI_COPPER,
                                                        RIN_SUSTAIN_ABILITY),
RING("levitation", "agate",
     LEVITATION,               1, 200, 1, 0,  7, GEMSTONE, CLR_RED,
                                                        RIN_LEVITATION),
RING("hunger", "topaz",
     HUNGER,                   1, 200, 1, 0,  8, GEMSTONE, CLR_CYAN,
                                                        RIN_HUNGER),
RING("aggravate monster", "sapphire",
     AGGRAVATE_MONSTER,        1, 200, 1, 0,  9, GEMSTONE, CLR_BLUE,
                                                        RIN_AGGRAVATE_MONSTER),
RING("conflict", "ruby",
     CONFLICT,                 1, 200, 1, 0,  9, GEMSTONE, CLR_RED,
                                                        RIN_CONFLICT),
RING("warning", "diamond",
     WARNING,                  1, 200, 1, 0, 10, GEMSTONE, CLR_WHITE,
                                                        RIN_WARNING),
RING("poison resistance", "pearl",
     POISON_RES,               1, 200, 1, 0,  4, BONE, CLR_WHITE,
                                                        RIN_POISON_RESISTANCE),
RING("fire resistance", "iron",
     FIRE_RES,                 1, 200, 1, 0,  5, IRON, HI_METAL,
                                                        RIN_FIRE_RESISTANCE),
RING("cold resistance", "brass",
     COLD_RES,                 1, 200, 1, 0,  4, COPPER, HI_COPPER,
                                                        RIN_COLD_RESISTANCE),
RING("shock resistance", "copper",
     SHOCK_RES,                1, 200, 1, 0,  3, COPPER, HI_COPPER,
                                                        RIN_SHOCK_RESISTANCE),
RING("free action", "twisted",
     FREE_ACTION,              1, 200, 1, 0,  6, IRON, HI_METAL,
                                                        RIN_FREE_ACTION),
RING("slow digestion", "steel",
     SLOW_DIGESTION,           1, 200, 1, 0,  8, IRON, HI_METAL,
                                                        RIN_SLOW_DIGESTION),
RING("teleportation", "silver",
     TELEPORT,                 1, 200, 1, 0,  3, SILVER, HI_SILVER,
                                                        RIN_TELEPORTATION),
RING("teleport control", "gold",
     TELEPORT_CONTROL,         1, 200, 1, 0,  3, GOLD, HI_GOLD,
                                                        RIN_TELEPORT_CONTROL),
RING("polymorph", "ivory",
     POLYMORPH,                1, 200, 1, 0,  4, BONE, CLR_WHITE,
                                                        RIN_POLYMORPH),
RING("polymorph control", "emerald",
     POLYMORPH_CONTROL,        1, 200, 1, 0,  8, GEMSTONE, CLR_BRIGHT_GREEN,
                                                        RIN_POLYMORPH_CONTROL),
RING("invisibility", "wire",
     INVIS,                    1, 200, 1, 0,  5, IRON, HI_METAL,
                                                        RIN_INVISIBILITY),
RING("see invisible", "engagement",
     SEE_INVIS,                1, 200, 1, 0,  5, IRON, HI_METAL,
                                                        RIN_SEE_INVISIBLE),
RING("withering", "ridged",
     WITHERING,                1, 200, 1, 0,  8, IRON, HI_METAL,
                                                        RIN_WITHERING),
RING("sleeping", "wedding",
     SLEEPY,                   1, 200, 1, 0,  7, GEMSTONE, CLR_WHITE,
                                                        RIN_SLEEPING),
RING("carrying", "glittery",
     0,                        1, 200, 1, 1,  7, GEMSTONE, CLR_WHITE,
                                                        RIN_CARRYING),
RING("protection from shape changers", "shiny",
     PROT_FROM_SHAPE_CHANGERS, 1, 200, 1, 0,  5, IRON, CLR_BRIGHT_CYAN,
                                               RIN_PROTECTION_FROM_SHAPE_CHAN),
/* Extra descriptions */
RING(NoDes, "embossed",     0, 0, 200, 1, 0, 3, GLASS, HI_GLASS,     RIN2),
RING(NoDes, "neon",         0, 0, 200, 1, 0, 0, PLASTIC, CLR_BLUE,   RIN3),
RING(NoDes, "quartz",       0, 0, 200, 1, 0, 7, GLASS, HI_GLASS,     RIN4),
RING(NoDes, "porcelain",    0, 0, 200, 1, 0, 8, GLASS, HI_MINERAL,   RIN5),
RING(NoDes, "ceramic",      0, 0, 200, 1, 0, 8, GLASS, HI_MINERAL,   RIN6),
RING(NoDes, "mithril",      0, 0, 200, 1, 0, 5, MITHRIL, HI_SILVER,  RIN7),
RING(NoDes, "platinum",     0, 0, 200, 1, 0, 3, PLATINUM, HI_METAL,  RIN8),
RING(NoDes, "jacinth",      0, 0, 200, 1, 0, 9, GEMSTONE, CLR_ORANGE,RIN9),
RING(NoDes, "citrine",      0, 0, 200, 1, 0, 6, GEMSTONE, CLR_ORANGE, RIN10),
RING(NoDes, "amber",        0, 0, 200, 1, 0, 2, GEMSTONE, CLR_BROWN, RIN11),
RING(NoDes, "jet",          0, 0, 200, 1, 0, 7, GEMSTONE, CLR_BLACK, RIN12),
RING(NoDes, "chrysoberyl",  0, 0, 200, 1, 0, 5, GEMSTONE, CLR_YELLOW,RIN13),
RING(NoDes, "obsidian",     0, 0, 200, 1, 0, 7, GEMSTONE, CLR_BLACK, RIN14),
RING(NoDes, "plain",        0, 0, 200, 1, 0, 7, MINERAL,  HI_MINERAL,RIN15),
RING(NoDes, "glass",        0, 0, 200, 1, 0, 7, GLASS,  CLR_CYAN,    RIN16),
RING(NoDes, "crystal",      0, 0, 200, 1, 0, 5, GLASS, HI_GLASS,     RIN17),
RING(NoDes, "plastic",      0, 0, 200, 1, 0, 1, PLASTIC, CLR_WHITE,  RIN18),
...
AMULET("amulet of reflection",        "hexagonal", REFLECTING, 35,
...
CONTAINER("oilskin sack",   "bag", 0, 0, 0, 20,  15, 100, CLOTH, HI_CLOTH,
                                                                OILSKIN_SACK),
CONTAINER("bag of holding", "bag", 0, 1, 0,  5,  15, 100, CLOTH, HI_CLOTH,
                                                               BAG_OF_HOLDING),
...
TOOL("magic marker",        NoDes, 1, 0, 1, 1, 0,  2, 500, PLASTIC, CLR_RED,
                                                                MAGIC_MARKER),
/* traps */
...
FOOD("eucalyptus leaf",       3,  1,  1, 0, VEGGY,   1, CLR_GREEN,
                                                          EUCALYPTUS_LEAF),
FOOD("mistletoe",             3,  1,  1, 0, VEGGY, 100, CLR_GREEN, MISTLETOE),
...
FOOD("melon",                10,  1,  5, 0, VEGGY, 100, CLR_BRIGHT_GREEN,
                                                          MELON),
FOOD("pineapple",            10,  2, 15, 0, VEGGY,  85, CLR_YELLOW, PINEAPPLE),
...
FOOD("holy wafer",           7, 1,  1, 0, VEGGY, 150, CLR_WHITE, HOLY_WAFER),
...
POTION("reflection",         "metallic",  1, REFLECTING, 10, 200, CLR_GRAY,
                                                        POT_REFLECTION),
POTION("phasing",               "soupy",  1, PASSES_WALLS, 20, 200, CLR_YELLOW,
                                                        POT_PHASING),
POTION("restore ability",        "pink",  1, 0, 40, 200, CLR_BRIGHT_MAGENTA,
                                                        POT_RESTORE_ABILITY),
POTION("confusion",            "orange",  1, CONFUSION, 40, 200, CLR_ORANGE,
                                                        POT_CONFUSION),
POTION("blindness",            "yellow",  1, BLINDED, 30, 200, CLR_YELLOW,
                                                        POT_BLINDNESS),
POTION("paralysis",           "emerald",  1, 0, 40, 200, CLR_BRIGHT_GREEN,
                                                        POT_PARALYSIS),
POTION("speed",            "dark green",  1, FAST, 40, 200, CLR_GREEN,
                                                        POT_SPEED),
POTION("levitation",             "cyan",  1, LEVITATION, 40, 200, CLR_CYAN,
                                                        POT_LEVITATION),
POTION("hallucination",      "sky blue",  1, HALLUC, 30, 200, CLR_CYAN,
                                                        POT_HALLUCINATION),
POTION("invisibility",         "indigo",  1, INVIS, 40, 200, CLR_BRIGHT_BLUE,
                                                        POT_INVISIBILITY),
...
POTION("extra healing",          "puce",  1, 0, 45, 200, CLR_RED,
                                                        POT_EXTRA_HEALING),
POTION("gain level",          "glowing",  1, 0, 20, 200, CLR_WHITE,
                                                        POT_GAIN_LEVEL),
POTION("enlightenment",        "swirly",  1, 0, 20, 200, CLR_BROWN,
                                                        POT_ENLIGHTENMENT),
POTION("monster detection",    "bubbly",  1, 0, 40, 200, CLR_WHITE,
                                                        POT_MONSTER_DETECTION),
POTION("object detection",      "smoky",  1, 0, 40, 200, CLR_GRAY,
                                                        POT_OBJECT_DETECTION),
POTION("gain energy",          "cloudy",  1, 0, 40, 200, CLR_WHITE,
                                                        POT_GAIN_ENERGY),
POTION("sleeping",       "effervescent",  1, 0, 40, 200, CLR_GRAY,
                                                        POT_SLEEPING),
POTION("full healing",          "black",  1, 0, 10, 200, CLR_BLACK,
                                                        POT_FULL_HEALING),
POTION("polymorph",            "golden",  1, 0, 10, 200, CLR_YELLOW,
                                                        POT_POLYMORPH),
POTION("booze",                 "brown",  0, 0, 40, 200, CLR_BROWN,
                                                        POT_BOOZE),
POTION("sickness",              "fizzy",  0, 0, 40, 200, CLR_CYAN,
                                                        POT_SICKNESS),
POTION("fruit juice",            "dark",  0, 0, 40, 200, CLR_BLACK,
                                                        POT_FRUIT_JUICE),
POTION("acid",                  "white",  0, 0, 10, 200, CLR_WHITE,
                                                        POT_ACID),
POTION("milk",                  "milky",  0, 0, 40, 100, CLR_WHITE,
                                                        POT_MILK),
POTION("oil",                   "murky",  0, 0, 30, 200, CLR_BROWN,
                                                        POT_OIL),
/* fixed description
 */
POTION("water",                 "clear",  0, 0, 80, 100, CLR_CYAN,
                                                        POT_WATER),
POTION("blood",             "blood-red",  0, 0, 0,  100, CLR_RED,
                                                        POT_BLOOD),
POTION("vampire blood",     "blood-red",  1, 0, 0,  200, CLR_RED,
                                                        POT_VAMPIRE_BLOOD),
#undef POTION
...
SCROLL("destroy armor",         "JUYED AWK YACC",  1,  45, 200,
                                                        SCR_DESTROY_ARMOR),
SCROLL("confuse monster",                 "NR 9",  1,  53, 200,
                                                        SCR_CONFUSE_MONSTER),
SCROLL("scare monster",   "XIXAXA XOXAXA XUXAXA",  1,  35, 200,
                                                        SCR_SCARE_MONSTER),
...
SCROLL("light",                 "VERR YED HORRE",  1,  90, 200,
                                                        SCR_LIGHT),
SCROLL("teleportation",        "VENZAR BORGAVVE",  1,  55, 200,
                                                        SCR_TELEPORTATION),
SCROLL("gold detection",                 "THARR",  1,  33, 200,
                                                        SCR_GOLD_DETECTION),
SCROLL("food detection",               "YUM YUM",  1,  25, 200,
                                                        SCR_FOOD_DETECTION),
SCROLL("knowledge",                   "POTESTAS",  1, 140,  100,
                                     /* power */        SCR_KNOWLEDGE),
SCROLL("identify",                  "KERNOD WEL",  1,  40,  100,
                                                        SCR_IDENTIFY),
SCROLL("magic mapping",              "ELAM EBOW",  1,  45, 200,
                                                        SCR_MAGIC_MAPPING),
SCROLL("flood",            "EGULED EL IOM SERPA",  1,  35, 200,
                                                        SCR_FLOOD),
...
#define SPELL(name,desc,sub,prob,delay,level,mgc,dir,color,sn)  \
    OBJECT(OBJ(name, desc),                                             \
           ...
           0, SPBOOK_CLASS, prob, delay, level * 5 + 30, level * 100,   \
...
SPELL("fireball",        "ragged",
      P_MATTER_SPELL,      20,  4, 4, 1, RAY, HI_PAPER, SPE_FIREBALL),
SPELL("cone of cold",    "dog eared",
      P_MATTER_SPELL,      10,  7, 4, 1, RAY, HI_PAPER, SPE_CONE_OF_COLD),
SPELL("sleep",           "mottled",
...
SPELL("lightning",        "electric blue",
      P_ATTACK_SPELL,      10,  8, 5, 1, RAY, CLR_BRIGHT_BLUE, SPE_LIGHTNING),
SPELL("poison blast",     "olive green",
      P_ATTACK_SPELL,      10,  9, 5, 1, RAY, CLR_GREEN, SPE_POISON_BLAST),
SPELL("light",           "cloth",
...
SPELL("drain life",      "velvet",
      P_ATTACK_SPELL,      10,  2, 3, 1, RAY, CLR_MAGENTA,
                                                        SPE_DRAIN_LIFE),
SPELL("fire bolt",       "feathered",
      P_ATTACK_SPELL,      15,  2, 1, 1, IMMEDIATE, CLR_YELLOW,
                                                        SPE_FIRE_BOLT),
SPELL("knock",           "pink",
...
SPELL("cure sickness",   "indigo",
      P_HEALING_SPELL,     32,  3, 3, 1, IMMEDIATE, CLR_BLUE,
                                                        SPE_CURE_SICKNESS),
...
SPELL("detect unseen",   "violet",
      P_DIVINATION_SPELL,  20,  4, 3, 1, NODIR, CLR_MAGENTA,
                                                        SPE_DETECT_UNSEEN),
SPELL("sacred vision",   "ghostly",
      P_CLERIC_SPELL,      20,  4, 2, 1, NODIR, CLR_BLACK,
                                                        SPE_SACRED_VISION),
SPELL("waterproofing",        "oilskin",
      P_MATTER_SPELL,      20,  4, 2, 1, NODIR, CLR_BRIGHT_GREEN,
                                                        SPE_WATERPROOFING),
...
SPELL("magic mapping",   "dusty",
      P_DIVINATION_SPELL,  18,  7, 4, 1, NODIR, HI_PAPER,
                                                        SPE_MAGIC_MAPPING),
SPELL("turn undead",     "copper",
      P_CLERIC_SPELL,      16,  8, 6, 1, IMMEDIATE, HI_COPPER,
                                                        SPE_TURN_UNDEAD),
SPELL("divine reckoning", "rainbow",
      P_CLERIC_SPELL,       7, 12, 8, 1, NODIR, HI_PAPER,
                                                        SPE_DIVINE_RECKONING),
...
SPELL("cancellation",    "shining",
      P_MATTER_SPELL,      15,  8, 7, 1, IMMEDIATE, CLR_WHITE,
                                                        SPE_CANCELLATION),
SPELL("flesh to stone",  "worn out",
      P_MATTER_SPELL,      10, 10, 7, 1, IMMEDIATE, CLR_GRAY,
                                                        SPE_FLESH_TO_STONE),
...
WAND("secret door detection",
                        "balsa", 50, 200, 1, NODIR, WOOD, HI_WOOD,
...
WAND("make invisible", "marble", 45, 200, 1, IMMEDIATE, MINERAL, HI_MINERAL,
                                                    WAN_MAKE_INVISIBLE),
WAND("identify",       "forked", 15, 200, 1, NODIR,     WOOD,  HI_WOOD,
                                                    WAN_IDENTIFY),
WAND("slow monster",      "tin", 50, 200, 1, IMMEDIATE, METAL, HI_METAL,
                                                    WAN_SLOW_MONSTER),
WAND("speed monster",   "brass", 50, 200, 1, IMMEDIATE, COPPER, HI_COPPER,
                                                    WAN_SPEED_MONSTER),
WAND("undead turning", "copper", 50, 200, 1, IMMEDIATE, COPPER, HI_COPPER,
                                                    WAN_UNDEAD_TURNING),
WAND("polymorph",      "silver", 15, 200, 1, IMMEDIATE, SILVER, HI_SILVER,
                                                    WAN_POLYMORPH),
...
WAND("magic missile",   "steel", 50, 200, 1, RAY, IRON, HI_METAL,
                                                    WAN_MAGIC_MISSILE),
WAND("fire",        "hexagonal", 40, 200, 1, RAY, IRON, HI_METAL,
                                                    WAN_FIRE),
WAND("cold",            "short", 40, 200, 1, RAY, IRON, HI_METAL,
                                                    WAN_COLD),
WAND("sleep",           "runed", 50, 200, 1, RAY, IRON, HI_METAL,
                                                    WAN_SLEEP),
WAND("death",            "long",  5, 200, 1, RAY, IRON, HI_METAL,
                                                    WAN_DEATH),
WAND("lightning",      "curved", 30, 200, 1, RAY, IRON, HI_METAL,
                                                    WAN_LIGHTNING),
WAND("poison gas",  "octagonal", 30, 200, 1, RAY, GLASS, HI_METAL,
                                                    WAN_POISON_GAS),
WAND("corrosion",    "twisted",  35, 200, 1, RAY, WOOD,  HI_WOOD,
                                                    WAN_CORROSION),
WAND("draining",      "ceramic", 30, 200, 1, RAY, GLASS,  HI_MINERAL,
                                                    WAN_DRAINING),
/* extra descriptions, shuffled into use at start of new game */
