...
#define HACKDIR "/boot/apps/NerfHack"
#endif
#endif
...
/* CONFIG_ERROR_SECURE: If user makes NERFHACKOPTIONS point to a file ...
 ...
 * to be set in user's config file or NERFHACKOPTIONS.  When set, if
